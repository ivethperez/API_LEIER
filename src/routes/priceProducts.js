...
router.get("/by-product/:productId/:unitOfMeasureId",authenticateToken,priceProductController.getByProductAndUnit);
router.get('/', priceProductController.getPriceProducts);
